...
df<-data.frame()
df<-rbind(m1[,1],m2[,1],m3[,1],m4[,1],m5[,1],m6[,1],m7[,1],m8[,1],m9[,1],m10[,1])
rownames(df)<-c("linePred","ridgePred","lassoPred","forPred","bagPred","ctrePred","cartPred","marsPred","knnPred","svmPred")
