...
#Locally
stData<- read.csv("C:\\Users\\zhero\\Documents\\GitHub\\data624Group5\\Project2\\StudentData.csv", header = TRUE)
...
#Locally
stEval<- read.csv("C:\\Users\\zhero\\Documents\\GitHub\\data624Group5\\Project2\\StudentEvaluation.csv", header = TRUE)
```
...
#glimpse(stData)
print(paste0("The dataset has ", dim(stData)[1], " rows and ", dim(stData)[2], " columns."))

#Response Variable
stData[colnames(stData) == "PH"] #Column 26

#Update factor
stData$Brand.Code <-as.factor(stData$Brand.Code)
table(stData$Brand.Code)
```
